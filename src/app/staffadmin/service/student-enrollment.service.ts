...
import { HttpClient,HttpEvent, HttpEventType, HttpErrorResponse, HttpHeaders, HttpBackend } from '@angular/common/http';
...
upload(formData) {
  ...
  return this.http.post<any>(this.serverUrl + 'staffadmin/enrollment/uploadPhoto/',formData)
  .pipe(
    catchError(this.handleError)
  );
...
fileUpload(fd){
  return this.http.post<any>('http://localhost:4200/assets/images/general',fd)
  .pipe(
    catchError(this.handleError)
  );
}
...
getEventBookData(evenId,schoolId,gameId,ageRange,gender){
  let str = 'staffadmin/enrollment/getEventBookData/' + evenId +'/' +schoolId +'/' + gameId +'/' +ageRange +'/' + gender;
  return this.http.get(this.serverUrl + str).pipe(
    catchError(this.handleError)
 );
}
...
getSubGameData(gameid, ageRange, gender,userType) {
  let str = 'staffadmin/enrollment/getSubGames/' + gameid +'/' +ageRange +'/' +gender +'/' +userType;
  return this.http.get(this.serverUrl + str).pipe(
    catchError(this.handleError)
 );
}
...
//     catchError(this.handleError)
//  );
 return this.http.post<any>(this.serverUrl + 'staffadmin/enrollment/getStudentList/',studentInfo)
 .pipe(
   catchError(this.handleError)
 );
...
saveStudentData(studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/enrollment/enrollStudent',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
bookEventData(studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/enrollment/bookEventData',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
saveCoachData(studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/coach/saveCoachData',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
saveVolunteerData(studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/volunteer/saveVolunteerData',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
loadVolunteerData(coachInfo){
  return this.http.post<any>(this.serverUrl + 'staffadmin/volunteer/getVolunteerData/',coachInfo)
  .pipe(
    catchError(this.handleError)
  );
...
updateVolunteersData (studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/volunteer/updateVolunteerData',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
updateStudentData (studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/enrollment/updateStudent',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
...
updateCoachData (studentInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/coach/updateCoachData',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
deleteStudent(id: number) {
  return this.http.delete(this.serverUrl + 'staffadmin/enrollment/deleteStudent/' + id).pipe(
    catchError(this.handleError)
  );
}
cancelBooking(id: number) {
  return this.http.delete(this.serverUrl + 'staffadmin/enrollment/cancelBooking/' + id).pipe(
    catchError(this.handleError)
  );
}
deleteCoach(id: number) {
  return this.http.delete(this.serverUrl + 'staffadmin/coach/deleteCoach/' + id).pipe(
    catchError(this.handleError)
  );
}
deleteVolunteer(id: number) {
  return this.http.delete(this.serverUrl + 'staffadmin/volunteer/deleteVolunteer/' + id).pipe(
    catchError(this.handleError)
  );
}
getGameData(gameInfo) {
  return this.http.post<any>(this.serverUrl + 'staffadmin/enrollment/getGameData',gameInfo)
  .pipe(
    catchError(this.handleError)
  );
